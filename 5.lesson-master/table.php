<?php
	...
	*/
	if(isset($_GET["delete"])){
		...
		$stmt = $mysql->prepare("UPDATE message_sample SET deleted=NOW() WHERE id = ?");
	...
	//SQL sentence
	$stmt = $mysql->prepare("SELECT id, recipient, message, created FROM message_sample Where deleted IS NULL
